...
RESULTS_DIR = "results/optuna_plots_10_fewshot_mini_25_trials_TEST2_0611/"
RANDOM_SEED = 28
random.seed(RANDOM_SEED) #28 werkte erg goed

# STUDY NAME + RESULTS
STUDY_NAME = "10_fewshot_mini_0611_optuna"  # ← change per study run
...
SOBOL_TRIALS = 10
TPE_TRIALS =  10
TOTAL_TARGET = SOBOL_TRIALS + TPE_TRIALS
...
def objective(trial, validation_queries, ground_truth_ids, collection, train_eval_queries, train_eval_gt_ids):
  ...
  # 🔹 extra check: performance op sample uit training
    ...
    # print("This is trial:", trial.number)
    # # Restart every 10 trials
    # if trial.number % 10 == 0 and trial.number  < TOTAL_TARGET:
    #     print("🔄 Restarting process to prevent CUDA fragmentation.")
    #     import sys
